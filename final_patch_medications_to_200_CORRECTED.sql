...
INSERT OR IGNORE INTO medications (id, name, generic_name, category_id, cyp450_enzyme, description, common_dosage, half_life_hours, withdrawal_risk_score, max_weekly_reduction_pct, can_reduce_to_zero, cbd_interaction_strength) VALUES
(218, 'Furosemid', 'Furosemid', 18, NULL, 'Schleifendiuretikum', '20-80 mg/Tag', 1.5, 6, 15, 0, 'low'),
(219, 'Hydrochlorothiazid', 'Hydrochlorothiazid', 18, NULL, 'Thiaziddiuretikum', '12.5-50 mg/Tag', 10, 6, 15, 0, 'low'),
(220, 'Spironolacton', 'Spironolacton', 18, 'CYP3A4', 'Kaliumsparendes Diuretikum', '25-100 mg/Tag', 20, 6, 15, 0, 'medium');
