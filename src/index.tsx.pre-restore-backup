  ...
  <style>
    * {
    ...
    .form-group select:focus {
      outline: none;
      border-color: #2FB585;
      box-shadow: 0 0 0 3px rgba(47, 181, 133, 0.1);
    }
    .radio-group {
      display: grid;
    ...
    button {
      ...
      box-shadow: 0 2px 6px rgba(47, 181, 133, 0.15) !important;
    }
    button:hover {
      background: #1B9C6E !important;
      transform: translateY(-2px) !important;
      box-shadow: 0 4px 12px rgba(47, 181, 133, 0.25) !important;
    }
    .step-hidden {
  ...
  <div class="wizard-card">
    <form id="wizard-form">
      ...
      <div id="step-1" class="form-step">
        <h2 style="font-size: 24px; font-weight: 300; margin-bottom: 10px; color: #1B2A36;">Schritt 1: Persönliche Angaben</h2>
        <p style="color: #5E6A71; margin-bottom: 25px;">Damit wir Sie persönlich ansprechen können.</p>
        ...
        <div class="form-group">
          ...
          <div class="radio-group">
            <div class="radio-option">
              <input type="radio" id="gender-herr" name="gender" value="herr" required>
              <label for="gender-herr">Herr</label>
            </div>
            <div class="radio-option">
              <input type="radio" id="gender-frau" name="gender" value="frau">
              <label for="gender-frau">Frau</label>
            </div>
            <div class="radio-option">
              <input type="radio" id="gender-divers" name="gender" value="divers">
              <label for="gender-divers">Divers</label>
            </div>
          </div>
        </div>
      ...
      <!-- STEP 2 -->
      <div id="step-2" class="form-step step-hidden">
        <h2 style="font-size: 24px; font-weight: 300; margin-bottom: 10px; color: #1B2A36;">Schritt 2: Körperdaten</h2>
        <p style="color: #5E6A71; margin-bottom: 25px;">Diese Angaben helfen bei der Einordnung.</p>
        
        <div class="form-group">
          <label for="age">Alter (Jahre) *</label>
          <input type="number" id="age" name="age" placeholder="z.B. 45" required>
        </div>

        <div class="form-group">
          <label for="weight">Gewicht (kg) *</label>
          <input type="number" id="weight" name="weight" placeholder="z.B. 70" required>
        </div>

        <div class="form-group">
          <label for="height">Größe (cm) *</label>
          <input type="number" id="height" name="height" placeholder="z.B. 170" required>
        </div>
