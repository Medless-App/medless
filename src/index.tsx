...
app.get('/app', (c) => {
  return c.html(`
    ...
    <body class="font-sans bg-white text-medless-text-primary">
      
      <!-- HEADER (identical to Landing, but app-specific CTA) -->
      <header class="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-medless-border-light shadow-sm">
        <div class="max-w-7xl mx-auto px-4 md:px-7 py-4 md:py-5 flex items-center justify-between">
          ...
          <!-- Desktop Navigation -->
          <ul class="hidden md:flex items-center gap-7">
            <li><a href="/#how-it-works" class="text-[15px] text-medless-text-secondary hover:text-medless-primary transition-colors duration-200">So funktioniert's</a></li>
            <li><a href="/#benefits" class="text-[15px] text-medless-text-secondary hover:text-medless-primary transition-colors duration-200">Vorteile</a></li>
            <li><a href="/#faq" class="text-[15px] text-medless-text-secondary hover:text-medless-primary transition-colors duration-200">FAQ</a></li>
            <li><a href="/magazin/" class="text-[15px] text-medless-text-secondary hover:text-medless-primary transition-colors duration-200">Magazin</a></li>
            <li><a href="/fachkreise/" class="text-[15px] text-medless-text-secondary hover:text-medless-primary transition-colors duration-200">Für Ärzt:innen & Apotheken</a></li>
          </ul>
          
          <!-- Desktop CTA Button (App-specific: "Zur Startseite") -->
          <a
            href="/" 
            class="hidden md:inline-flex items-center justify-center gap-2 px-5 py-2 rounded-xl border-2 border-medless-primary text-medless-primary bg-white text-[15px] font-medium transition-all duration-200 hover:bg-medless-primary hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-medless-primary/40"
          >
            Zur Startseite
          </a>
          ...
          >
            <svg width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="18" x2="21" y2="18"/></svg>
          </button>
        </div>
      </header>
      ...
      <!-- MOBILE NAVIGATION OVERLAY -->
      <div id="mobile-nav-overlay" class="hidden fixed inset-0 bg-black/30 z-50">
        <div class="max-w-xs w-full ml-auto bg-white h-full shadow-lg flex flex-col">
          <!-- Header -->
          <div class="flex items-center justify-between p-5 border-b border-medless-border-light">
            <a href="/" class="text-xl font-semibold text-medless-text-primary tracking-tight">
              Medless
          ...
          <nav class="flex-1 overflow-y-auto p-5">
            <ul class="space-y-2">
              <li>
                <a href="/#how-it-works" class="mobile-nav-link block px-4 py-3 text-base font-medium text-medless-text-primary hover:bg-medless-bg-ultra-light rounded-xl transition-colors">
                  So funktioniert's
                </a>
              </li>
              <li>
                <a href="/#benefits" class="mobile-nav-link block px-4 py-3 text-base font-medium text-medless-text-primary hover:bg-medless-bg-ultra-light rounded-xl transition-colors">
                  Vorteile
                </a>
              </li>
              <li>
                <a href="/#faq" class="mobile-nav-link block px-4 py-3 text-base font-medium text-medless-text-primary hover:bg-medless-bg-ultra-light rounded-xl transition-colors">
                  FAQ
                </a>
              </li>
              <li>
                <a href="/magazin/" class="mobile-nav-link block px-4 py-3 text-base font-medium text-medless-text-primary hover:bg-medless-bg-ultra-light rounded-xl transition-colors">
                  Magazin
                </a>
              </li>
              <li>
                <a href="/fachkreise/" class="mobile-nav-link block px-4 py-3 text-base font-medium text-medless-text-primary hover:bg-medless-bg-ultra-light rounded-xl transition-colors">
                  Für Ärzt:innen & Apotheken
                </a>
              </li>
            </ul>
          ...
          <div class="p-5 border-t border-medless-border-light">
            <a 
              href="/" 
              class="inline-flex items-center justify-center gap-2 w-full px-5 py-3 text-white bg-medless-primary border border-medless-primary rounded-xl shadow-sm hover:bg-medless-primary-dark hover:-translate-y-0.5 hover:shadow-md transition-all duration-200 active:scale-[0.97]"
            >
