...
<body class="min-h-screen bg-medless-bg-ultra-light flex flex-col">
  ...
  <main style="min-height: 400px; background: #ffe4e6; border-top: 4px solid #fb7185; border-bottom: 4px solid #fb7185;">
    <div style="max-width: 960px; margin: 80px auto; padding: 40px; background: #ffffff; border: 3px dashed #fb7185; border-radius: 16px; text-align: center; font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif;">
      <h1 style="font-size: 32px; font-weight: 700; margin-bottom: 16px;">
        DEBUG: MEDLESS /app MAIN-BEREICH
      </h1>
      <p style="font-size: 18px; margin-bottom: 8px;">
        Wenn du diesen Block im Browser zwischen Header und Footer siehst, ist der MAIN-Bereich korrekt sichtbar.
      </p>
      <p style="font-size: 16px; color: #4b5563;">
        Danach können wir hier wieder den Wizard einbauen. Erstmal geht es nur um die Sichtbarkeit.
      </p>
    </div>
  </main>
