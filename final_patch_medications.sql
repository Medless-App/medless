...
-- Beta-Blocker
INSERT OR REPLACE INTO medications (name, generic_name, category_id, risk, withdrawal_risk_score, half_life_hours, max_weekly_reduction_pct, can_reduce_to_zero, cbd_interaction_strength, cyp450_enzyme, notes)
VALUES
